...
| H17 — `GET /api/sessions` renvoie les codes de présence | Sans authentification (Q1), n'importe qui peut appeler cette opération | L'écran étudiant ne montre jamais le code : il n'utilise cette liste que pour les titres et les statuts. Le contrat reste inchangé | Risque résiduel assumé, conséquence directe de Q1. À traiter par une authentification dans une version ultérieure |
