...
/**
 * B4 / ENF3 : toute erreur renvoyee au client suit le format { code, message }.
 * Aucune stack trace ne sort de l'API.
 */
...
public class GlobalExceptionHandler {
    ...
    /** Le message d'une annotation de validation porte le code d'erreur, par exemple @NotNull(message = "CHAMP_MANQUANT"). */
