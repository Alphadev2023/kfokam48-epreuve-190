-- V1 : schema initial, conforme au diagramme D2 (docs/diagrammes/D2-modele-donnees.md)
...
CREATE TABLE session_cours (
                               ...
                               CONSTRAINT uk_session_code UNIQUE (code),                                   -- RG19
                               CONSTRAINT ck_session_statut CHECK (statut IN ('OUVERTE', 'CLOTUREE')),     -- H1
...
CREATE TABLE presence (
                          ...
                          CONSTRAINT uk_presence_session_etudiant UNIQUE (session_id, etudiant_id),   -- RG5
                          CONSTRAINT ck_presence_source CHECK (source IN ('ETUDIANT', 'FORMATEUR')),  -- RG7
...
CREATE TABLE exercice (
                          ...
                          CONSTRAINT uk_exercice_session_etudiant UNIQUE (session_id, etudiant_id),   -- RG8
                          CONSTRAINT ck_exercice_statut CHECK (statut IN ('EN_ATTENTE_ATTRIBUTION', 'EN_ATTENTE_RELECTURE', 'RELU')),
...
CREATE TABLE relecture (
                           ...
                           CONSTRAINT uk_relecture_exercice UNIQUE (exercice_id),                      -- RG12
                           CONSTRAINT ck_relecture_note CHECK (note BETWEEN 0 AND 20),                 -- RG3
